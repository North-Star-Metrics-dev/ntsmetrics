...
class Iphone51TransactiondetailsScreen extends StatefulWidget {
  const Iphone51TransactiondetailsScreen({super.key});

  @override
  State<Iphone51TransactiondetailsScreen> createState() => _TransactiondetailsScreenState();
}

class _TransactiondetailsScreenState extends State<Iphone51TransactiondetailsScreen> {
  @override
