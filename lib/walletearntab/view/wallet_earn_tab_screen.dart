...
class WalletEarnTabScreen extends StatefulWidget {
  const WalletEarnTabScreen({super.key});

  @override
  State<WalletEarnTabScreen> createState() => _WalletEarnTabScreenState();
}

class _WalletEarnTabScreenState extends State<WalletEarnTabScreen> {
  int selectedIndex = -1;
