...
class AlgorandSubscriptionScreen extends StatefulWidget {
  const AlgorandSubscriptionScreen({super.key});

  @override
  State<AlgorandSubscriptionScreen> createState() => _AlgorandSubscriptionScreenState();
}

class _AlgorandSubscriptionScreenState extends State<AlgorandSubscriptionScreen> {
                    ...
                    child: Padding(
                      ...
                      child: Text(
                        ...
                        style: GoogleFonts.alata(
                            fontWeight: FontWeight.w600,
                            fontSize: 17.47,
                            color: isButtonEnabled ? Color(0xFFFAFBFC) : Color(0xFF51586D)
                        ),
                      ),
                    ),
                  ),
