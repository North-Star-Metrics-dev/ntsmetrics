...
class EarntransactionlistScreen extends StatefulWidget {
  const EarntransactionlistScreen({super.key});

  @override
  State<EarntransactionlistScreen> createState() => _EarntransactionlistScreenState();
}

class _EarntransactionlistScreenState extends State<EarntransactionlistScreen> {
  int selectedIndex = 1;
  @override
